...
class Booking extends Model
{
    ...
    public function getActivitylogOptions(): LogOptions
    {
        ...
        return LogOptions::defaults()
            ->setDescriptionForEvent(fn(string $eventName) => "Booking successfully {$eventName} by " . Auth::user()->name . " using " . $agent->browser() . " on " . $agent->platform() . " from " . request()->ip());
    }
